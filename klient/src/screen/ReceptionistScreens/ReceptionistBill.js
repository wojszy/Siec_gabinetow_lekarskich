...
import AddBill from "../../components/receptionistBill/AddBill";

function ReceptionistBill() {
      ...
      <div id="wrapper" class="toggled">
        ...
        <div id="page-content-wrapper">
          <div class="container-fluid">
            <h1>Strona wystawiania faktur</h1>
            <AddBill patient={data}></AddBill>
          </div>
        </div>
      </div>
    </div>
...
export default ReceptionistBill;
